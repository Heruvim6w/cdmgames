            ...
            <table class="content_mr_css_attr" role="presentation"
                ...
                <tr>
                    <td class="header_mr_css_attr"
                        ...
                        <a style="box-sizing: border-box;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';color: #3d4852;font-size: 19px;font-weight: bold;text-decoration: none;display: inline-block;"
                            ...
                            <tr>
                                <td class="content-cell_mr_css_attr"
                                    ...
                                    <p style="box-sizing: border-box;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';font-size: 16px;line-height: 1.5em;margin-top: 0;text-align: left;">
                                        Это письмо вы получили, так как создали новый способ вывода средств на
                                        сайте.</p>
                                    <table class="action_mr_css_attr" role="presentation"
                                                                ...
                                                                <tr>
                                                                    <td style="box-sizing: border-box;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';">
                                                                        <a href="{{ $url }}"
                                                                           ...
                                                                           rel=" noopener noreferrer">Подтвердить новый
                                                                            метод вывода</a>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                    ...
                                    <p style="box-sizing: border-box;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';font-size: 16px;line-height: 1.5em;margin-top: 0;text-align: left;">
                                        Если вы получили то сообщение случайно, проигнорируйте его</p>
                                    <p style="box-sizing: border-box;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';font-size: 16px;line-height: 1.5em;margin-top: 0;text-align: left;">
                                        С уважением,<br>
                                        cdmgames.com</p>


                                    <table class="subcopy_mr_css_attr" role="presentation"
                                        ...
                                        <tr>
                                            <td style="box-sizing: border-box;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';">
                                                <p style="box-sizing: border-box;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';line-height: 1.5em;margin-top: 0;text-align: left;font-size: 14px;">
                                                    Если у вас возникли проблемы с нажатием кнопки "Подтвердить новый
                                                    метод вывода", скопируйте и вставьте приведенный ниже URL
                                                    в веб-браузер: <span class="break-all_mr_css_attr"
                                                            ...
                                                            target="_blank"
                                                            rel=" noopener noreferrer">{{ $url }}</a></span></p>
                ...
                <tr>
                    <td style="box-sizing: border-box;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';">
                        <table class="footer_mr_css_attr" role="presentation"
                            ...
                            <tr>
                                <td class="content-cell_mr_css_attr"
                                    ...
                                    <p style="box-sizing: border-box;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';line-height: 1.5em;margin-top: 0;color: #b0adc5;font-size: 12px;text-align: center;">
                                        © 2022 cdmgames.com. All rights reserved.</p>
