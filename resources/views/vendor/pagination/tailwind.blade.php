            ...
            <div class="text-center">
                <p class="text-sm text-gray-700 leading-5">
                    ...
                    @if ($paginator->firstItem())
                        <span class="results font-medium">{{ $paginator->firstItem() }}</span>
                        {!! __('до') !!}
                        <span class="results font-medium">{{ $paginator->lastItem() }}</span>
                    @else
                        {{ $paginator->count() }}
                    @endif
                    {!! __('и') !!}
                    <span class="results font-medium">{{ $paginator->total() + 1898 }}</span>
                    {!! __('результатов') !!}
                </p>
            </div>
