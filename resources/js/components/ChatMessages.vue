<template>
    <div ref="chat">
        <div v-if="messages.length < 1" class="text-center EmptyDialogStub__description">
            ...
            <p>Рабочие часы чата: с 10:00 по 23:00 по МСК.</p>
            <p>Чтобы продать аккаунт подайте заявку на главное странице сайте по кнопке "оставить заявку на продажу"</p>
            <p>Если у Вас возникли вопросы при отправке заявки, то можете обратиться в данный чат с вопросом</p>
        </div>
