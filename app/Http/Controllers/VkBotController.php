    ...
    public function replenishmentFromBot(Request $request): void
    {
        ...
        switch ($data->type) {
            ...
            case 'message_new':
				...
				Оставьте отзыв по ссылке https://vk.ru/topic-176494199_40223406 и Вам будет начислен рандомный денежный бонус на баланс.

				Для получения бонуса, необходимо сделать скриншот отзыва и отправить его в сообщения группы ВКонтакте - vk.ru/cdmgames";
            ...
            Оставьте отзывы по ссылке https://vk.ru/topic-176494199_40223406  и Вам будет начислен рандомный денежный бонус на баланс.
